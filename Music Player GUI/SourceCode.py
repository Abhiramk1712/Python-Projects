...
Button1 = tk.Button(music_player, width=5, height=3, font="Helvatica 12 bold", text="PLAY", command=play, bg="blue",fg="white")
...
var = tk.StringVar()
song_title = tk.Label(music_player, font = "Helvatica 12 bold", textvariable = var)
